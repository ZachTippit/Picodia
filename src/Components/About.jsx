  ...
  return (
    <div id={'about'} className={'fade-in-bottom ' + (isDarkMode ? 'dark-theme ' : 'light-theme ') + (closing && 'fade-out-bottom')}>
      ...
      <div className={'how-to-play'}>
        ...
        <ExampleRow exClue={"5"} exArray={[1,1,1,1,1]} nextStart={nextAnim} order={1} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <p>Some clues are obvious and can be figured out from context (ex: 5 blocks long and a space between each number...)</p>
        <ExampleRow exClue={"2 2"} exArray={[1,1,'',1,1]} nextStart={nextAnim} order={2} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <p><b>Careful!</b> Even if the numbers are consecutive, you must use the other clues to determine where it goes.</p>
        <ExampleRow exClue={"4"} exArray={[1,1,1,1,'']} nextStart={nextAnim} order={3} onToNext={onToNext} isDarkMode={isDarkMode}/>
        ...
        <ExampleRow exClue={"3 1"} exArray={[1,1,1,'',1]} nextStart={nextAnim} order={4} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <ExampleRow exClue={"2 1"} exArray={[1,1,'','',1]} nextStart={nextAnim} order={4} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <p><b>You only get one chance a day, so play carefully ;)</b> Don't lose all of your lives!</p>
        <LoseExampleRow exClue={"2"} exArray={[1,1,0,0,0]} nextStart={nextAnim} order={5} onToNext={onToNext} isDarkMode={isDarkMode}/>
