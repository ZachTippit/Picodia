...
const ExampleGrid = ({nextStart, order, isDarkMode}) => {
  ...
  return (
    ...
    <Grid container columns={4} width='70%' mb={4}  justifyContent='center' className='ex-grid3-3' ml={4}>
        ...
        <ExampleRow exClue={"3"} exArray={[1,1,1]} nextStart={nextAnim} order={0} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <ExampleRow exClue={"1"} exArray={[1,'','']} nextStart={nextAnim} order={1} onToNext={onToNext} isDarkMode={isDarkMode}/>
        <ExampleRow exClue={"3"} exArray={[1,1,1]} nextStart={nextAnim} order={2} onToNext={onToNext} isDarkMode={isDarkMode}/>
    </Grid>
  )
}
